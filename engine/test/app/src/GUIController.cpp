...
void GUIController::draw() {
    ...
    graphics->begin_gui();
    // Draw brown_mud scale slider window
    // auto brown_mud  = engine::core::Controller::get<engine::resources::ResourcesController>()->model("brown_mud");
    // static float f = 0.0f;
    // ImGui::Begin(brown_mud->name().c_str());
    // ImGui::Text("Loaded from: %s", brown_mud->path().c_str());
